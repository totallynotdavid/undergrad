...
class PredefinedWavelengths:
    ...
    # PeruSAT
    # Taken from spreadsheet downloadable from de las propiedades de PeruSAT
    # Interpolated to 2.5nm intervals, as required by 6S
    ...
    PeruSAT_PAN = (
        ...
        np.array(
            [
                ...
                0.18574689899691849,
                0.10206070897898464,
                0.057517758516805975,  
            ]
        ),
    ) 
    
    # SPOT 6
    # SPOT 6 MSI spectral response functions
    # Extraido de la pagina oficial de SPOT6
    SPOT6_B1 = (
        25,
        0.450,
        0.520,
    ...
    # SPOT 7
    # SPOT 7 MSI spectral response functions
    # Extraido de la pagina oficial de SPOT6
    SPOT7_B1 = (
        30,
        0.450,
    ...
    #PERUSAT_B1 = (20, 0.454,0.525)
    #PERUSAT_B2 = (21, 0.533,0.598,)
    #PERUSAT_B3 = (22, 0.633,0.702)
    #PERUSAT_B4 = (23, 0.764,0.884)
